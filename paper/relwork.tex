...
Our OpSets-based semantics can be seen as a variation on this idea, passing all operations observed at a node to the interpretation function and building the result from ``the bottom up'', rather than passing the downward-closure of observed events.
