...
\mathrm{isListParent}(\mathit{Oid}) \leftarrow\; &
    \mathrm{makeList}(\mathit{Oid}).\\
\mathrm{isListParent}(\mathit{Oid}) \leftarrow\; &
    \mathrm{isListElem}(\mathit{Oid}).\\
\mathrm{parentChild}(\mathit{Parent}, \mathit{Child}) \leftarrow\; &
    \mathrm{insertAfter}(\mathit{Child}, \mathit{Parent}),\;
    \mathrm{isListParent}(\mathit{Parent}).\\
\mathrm{hasChild}(\mathit{Parent}) \leftarrow\; &
    \mathrm{parentChild}(\mathit{Parent}, \mathit{Child}).\\
\mathrm{laterChild}(\mathit{Parent}, \mathit{Child2}) \leftarrow\; &
    \mathrm{parentChild}(\mathit{Parent}, \mathit{Child1}),\;
    \mathrm{parentChild}(\mathit{Parent}, \mathit{Child2}),\;
...
\mathrm{nextSiblingAnc}(\mathit{Start}, \mathit{Next}) \leftarrow\; &
    ...
    \mathrm{parentChild}(\mathit{Parent}, \mathit{Start}),\;
