...
\begin{align*}
    ...
    %%%%%%%%%%
    \mathit{interp}\big[(E,\, L),\, (\mathit{id},\, \mathsf{InsertAfter}(r)) \big] \;=\; \Big( & E,\;
    \big\{ (p,n) \in L \mid p \neq r \big\} \;\cup\;
    \big\{ (r, \mathit{id}) \big\} \;\cup\;
    \big\{ (\mathit{id}, n) \mid (r, n) \in L \big\} \Big) \\[10pt]
    %%%%%%%%%%
    \mathit{interp}\big[(E,\, L),\, (\mathit{id},\, \mathsf{MakeMap}) \big] \;=\; (E,\, L)&\qquad\qquad
    \mathit{interp}\big[(E,\, L),\, (\mathit{id},\, \mathsf{MakeVal}(\mathit{val})) \big] \;=\; (E,\, L)\\[4pt]
    \mathit{interp}\big[(E,\, L),\, (\mathit{id},\, \mathsf{MakeList}) \big] \;=\; (E,\, L)&
\end{align*}
