...
Moreover, locales can be extended with new assumed facts and fixed constants to form a hierarchy, and definitions and theorems may be defined and declared within the scope of a locale and therefore be made available to all concrete implementations of the locale.
