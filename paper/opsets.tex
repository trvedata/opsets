...
An unavoidable downside of these models is that any operation or transaction must wait for network communication before is allowed to complete \cite{Davidson:1985hv,Gilbert:2002il}.
