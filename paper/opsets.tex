...
In our sequential OpSet interpetation, operations are applied in strictly ascending order of ID; on the other hand, a CRDT allows operations to be applied in any causal order due to their commutativity.
