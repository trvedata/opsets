...
\item Using the Isabelle/HOL proof assistant we formalise the OpSets approach, producing mechanised proofs of correctness of the main claims in this paper.
...
\appendix
\section{Spare Material (delete if it doesn't fit)}
