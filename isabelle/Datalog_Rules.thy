...
inductive is_list_elem :: "'oid \<Rightarrow> bool"
  and is_list_parent   :: "'oid \<Rightarrow> bool"
  and parent_child     :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and has_child        :: "'oid \<Rightarrow> bool"
  and later_child      :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and sibling          :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and later_sibling    :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and later_sibling_2  :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and has_next_sibling :: "'oid \<Rightarrow> bool"
where
...
inductive first_child  :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and next_sibling     :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and next_sibling_anc :: "'oid \<Rightarrow> 'oid \<Rightarrow> bool"
  and has_sibling_anc  :: "'oid \<Rightarrow> bool"
where
...
inductive next_elem :: "'oid \<Rightarrow> 'oid option \<Rightarrow> bool"
where
